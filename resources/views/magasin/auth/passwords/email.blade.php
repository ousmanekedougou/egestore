    ...
    <main class="main" id="top">
      <div class="container">
        <div class="row flex-center min-vh-100 py-5">
          <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a class="d-flex flex-center text-decoration-none mb-4" href="{{ route('magasin.login') }}">
            ...
            <div class="px-xxl-5">
              <div class="text-center mb-6">
                ...
                <form action="{{route('magasin.verify')}}" method="POST" class="d-flex align-items-center mb-5">
                    @csrf
