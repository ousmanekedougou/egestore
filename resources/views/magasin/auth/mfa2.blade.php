@include('layouts.head',['title' => 'magasin-mfa2'])
<body>
     <!-- ===============================================-->
    <!--    Main Content-->
    <!-- ===============================================-->
          ...
          <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
            ...
            <div class="px-xxl-5">
              <div class="text-center mb-6">
                ...
                <form class="verification-form" data-2FA-varification="data-2FA-varification" method="post" action="{{ route('magasin.confirme',[$user->id,$user->confirmation_token]) }}">
                  @csrf
                  {{@method_field('PUT') }}
