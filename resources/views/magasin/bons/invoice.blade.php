        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb20 tm_mb10_md">
            <div class="tm_invoice_left">
              <div class="tm_logo">
                <img style="border-radius: 100%;" class="rounded-circle" src="@if ($bon->logo != '') {{(Storage::url($bon->magasin->logo))}} @else https://ui-avatars.com/api/?name={{$bon->magasin->name}} @endif" alt="Logo">
              </div>
            </div>
          ...
          <div class="tm_invoice_info tm_mb10">
            <div class="tm_invoice_info_left">
              ...
              <p>
                <b class="tm_f16 tm_primary_color">@if($bon->client_id != '') {{ $bon->client->name }} @elseif ($bon->user_id != '') {{ $bon->user->name }} @else {{ $bon->name }}@endif</b> <br>
            ...
            <div class="tm_invoice_info_right">
              <div class="tm_f50 tm_text_uppercase tm_text_center tm_invoice_title tm_mb15 tm_ternary_color tm_mobile_hide">BON MENSUEL</div>
              <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_round_border tm_gray_bg">
                <div>
                  <span>Numéro  No:</span> <br>
                  <b class="tm_f15 tm_accent_color">#{{ str_pad($bon->order, 5, '0', STR_PAD_LEFT) }}</b>
                </div>
                <div>
                ...
                <div>
                  ...
                  <b class="tm_f15 tm_accent_color">{{ number_format($bon->amount,2, ',','.') }} cfa</b>
                </div>
              </div>
            </div>
          </div>
                ...
                <table class="tm_mb15">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_primary_color tm_text_right tm_white_color tm_accent_bg tm_radius_0_6_6_0">{{ number_format($bon->amount,2, ',','.') }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
