...
<div class="content">
  <div class="mb-9">
    <div class="row g-3 mb-4">
      <div class="col-auto">
        <h2 class="mb-0">Bons clientel</h2>
      </div>
    </div>
        ...
        <div class="row g-3">
          ...
          <div class="col-auto">
            <button class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
              <span class="fas fa-plus me-2"></span>Ajouter une commande de bon
            </button>
          </div>
        </div>
      </div>
              ...
              @foreach($bons as $bon)
                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td class="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary">
                    <span class="badge badge-phoenix fs-10  @if($bon->status == 1) badge-phoenix-success @elseif($bon->status == 2) badge-phoenix-info @else badge-phoenix-warning @endif">
                      <span class="badge-label">@if($bon->status == 1) Terminé @elseif($bon->status == 2) Traitement @else Annulé @endif</span>
                      <span class="ms-1" 
                      @if($bon->status == 1)
                        data-feather="check" 
                      @elseif($bon->status == 2)
