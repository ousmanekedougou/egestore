          ...
          <table class="table table-sm fs-9 mb-0">
            <thead>
              <tr>
                ...
                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="order" style="width:5%;">Nº DEVIS</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{ route('magasin.reserve.update',$order->id) }}" method="post">
              ...
              {{ method_field('PUT') }}
              <div class="modal-body">
                <p class="text-body-tertiary lh-lg mb-3"> Reservation Nº {{ $order->order }} de  {{$order->name}} </p>
