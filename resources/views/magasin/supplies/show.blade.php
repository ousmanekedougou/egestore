...
<div class="content">
    <div class="mb-9">
      <div class="row align-items-center justify-content-between g-3 mb-4">
        <div class="col-auto">
          <h2 class="mb-0">Coordonnées du magasin</h2>
        </div>
        <div class="col-auto">
          <div class="row g-3">
            <div class="col-auto"><button class="btn btn-phoenix-danger"><span class="fa-solid fa-trash-can me-2"></span>Retirer</button></div>
            <div class="col-auto"><button class="btn btn-phoenix-secondary"><span class="fas fa-key me-2"></span>Ajouter comme fournisseur</button></div>
          </div>
        </div>
      </div>
      <div class="row g-5">
              ...
              <div class="card h-100">
                <div class="card-body d-flex flex-column justify-content-between pb-3">
                  ...
                  <div class="d-flex flex-between-center border-top border-dashed pt-4">
                    <div>
                      <h6>Employés</h6>
                      <p class="fs-7 text-body-secondary mb-0">{{ $magasin->agents->count() }}</p>
                    </div>
                    <div>
            ...
            <div class="col-12 col-md-5 col-xxl-12 mb-xxl-3">
              <div class="card h-100">
                <div class="card-body pb-3">
                  ...
                  <p class="text-body-secondary">{{ $magasin->address }}<br />Vancouver, British Columbia<br />Canada</p>
                  <div class="mb-3">
              ...
              <div class="card h-100">
                <div class="card-body">
                  ...
                  <form action="" method="post">
                    ...
                    <button class="btn btn-phoenix-primary w-100 mb-4">Ajouter une note</button>
                  </form>
