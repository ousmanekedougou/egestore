                ...
                <div class="col-6">
                  @if(ProductStockVide()->count() > 0 )
                    <div class="alert alert-danger d-flex align-items-center" role="alert">
                      <span class="fas fa-times-circle text-white fs-5 me-3"></span>
                      <p class="mb-0 flex-1">Vous avez {{ProductStockVide()->count()}} produits dont le stock est épuisé </p>
                ...
                <div class="col-6">
                  @if(ProductStockAlert()->count() > 0 )
                    <div class="alert alert-warning d-flex align-items-center" role="alert">
                      <span class="fas fa-info-circle text-white fs-5 me-3"></span>
                      <p class="mb-0 flex-1">Vous avez {{ProductStockAlert()->count()}} produits dont le stock est en phase d'epuisement</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                  @endif
                </div>
