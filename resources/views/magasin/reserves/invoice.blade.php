...
<head>
  ...
  <!-- Site Title -->
  <title>{{ $reserve->magasin->name }} - PRO-FORMAT</title>
        ...
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info tm_mb25">
            ...
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0">Numéro No: <b>#{{ str_pad($reserve->order, 5, '0', STR_PAD_LEFT) }}</b></p>
          ...
          <div class="tm_invoice_head tm_mb10">
            <div class="tm_invoice_left">
              ...
              <p>
                @if($reserve->client_id != '') {{ $reserve->client->name }} @elseif ($reserve->user_id != '') {{ $reserve->user->name }} @else {{ $reserve->name }}@endif <br>
            ...
            <div class="tm_invoice_right tm_text_right">
              ...
              <p>
                {{$reserve->magasin->name}} <br>
                {{$reserve->magasin->phone}}<br>
                {{$reserve->magasin->email}} <br>
          ...
          <div class="tm_table tm_style1">
            ...
            <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
              <div class="tm_left_footer">
                <p class="tm_mb2"><b class="tm_primary_color">RCCM:</b> <span class="tm_m0">{{ $reserve->magasin->registre_com }}</span></p>
                <p class="tm_mb2"><b class="tm_primary_color">NINEA:</b> <span class="tm_m0">{{ $reserve->magasin->ninea }}</span></p>
              </div>
                ...
                <table class="tm_mb15">
                  <tbody>
                    ...
                    <tr class="tm_accent_bg">
                      ...
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right">{{ $reserve->getAmount() }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
