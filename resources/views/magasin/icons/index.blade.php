...
<div class="content">
  <h2 class="mb-2 lh-sm">Icônes de plumes</h2>
  <p class="text-body-tertiary lead mb-2">Des icônes open source tout simplement magnifiques</p><a class="btn btn-link p-0" href="https://feathericons.com/" target="_blank">Documentation sur les icônes de plumes<span class="ms-1" data-feather="chevron-right"></span></a>
  <div class="mb-9">
      ...
      <div class="card-header p-4 border-bottom bg-body">
        <div class="row g-3 justify-content-between align-items-end">
          <div class="col-12 col-md">
            ...
            <p class="mb-0 mt-2 text-body-secondary">Vous pouvez utiliser ces icônes avec des classes d'aide de couleur et de taille de police, comme dans l'exemple ci-dessous:</p>
          </div>
          <div class="col col-md-auto">
            <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#example-code" role="button" aria-controls="example-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>Voir le code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Avant-première</a></nav>
          </div>
        </div>
      </div>
    ...
    <div class="card border mb-3" data-list='{"valueNames":["icon-list-item"]}'>
      <div class="card-header border-bottom bg-body">
        <div class="row flex-between-center g-2">
          <div class="col-auto">
            <h4 class="mb-0">Liste des icônes</h4>
          </div>
