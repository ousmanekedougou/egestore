    ...
    <main class="main" id="top">
      <div class="container">
        <div class="row flex-center min-vh-100 py-5">
          <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a class="d-flex flex-center text-decoration-none mb-4" href="{{ route('agent.login') }}">
            ...
            <div class="px-xxl-5">
              <div class=" mb-6">
                ...
                <form action="{{ route('agent.update',$email) }}" method="POST" class="d-block align-items-center mb-5">
                    @csrf
                    {{Method_field('PUT')}}
