          ...
          <div class="col-12 col-xl-10 col-xxl-8">
            <div class="row justify-content-center align-items-center g-5">
              ...
              <div class="col-12 col-lg-6 text-center text-lg-start"><img class="img-fluid mb-6 w-50 w-lg-75 d-dark-none" src="../../assets/img/spot-illustrations/403.png" alt="" /><img class="img-fluid mb-6 w-50 w-lg-75 d-light-none" src="../../assets/img/spot-illustrations/dark_403.png" alt="" />
                <h2 class="text-body-secondary fw-bolder mb-3">Accès non autorise !</h2>
                <p class="text-body mb-5">Halte ! Tu t'efforces d'empiéter sur un domaine qui ne t'est pas accordé.<br class="d-none d-sm-block" />t'a été accordée.</p><a class="btn btn-lg btn-primary" href="/">Retour a la page d'acceuil</a>
              </div>
            </div>
          </div>
        </div>
