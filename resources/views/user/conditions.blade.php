                ...
                <div class="timeline-basic mb-9">
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                                Bienvenue chez KStore ! En créant un compte KStore (tel que défini dans l'article 1) ou en utilisant les services KStore (tels que définis ci-dessous), vous acceptez d'être lié par les conditions générales suivantes (les « Conditions d'Utilisation »).
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                                Dans les présentes conditions de service, « nous », « notre », « nos » et « KStore » désignent la partie contractante de KStore concernée (telle que définie à l'article 13 ci-dessous), et « vous » désigne l'utilisateur de KStore (s'il s'inscrit à un service de KStore ou l'utilise en tant que particulier), ou l'entreprise qui emploie l'utilisateur de KStore (s'il s'inscrit à un service de KStore ou l'utilise en tant qu'entreprise) et l'une de ses sociétés affiliées.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                                KStore fournit une plateforme commerciale complète qui permet aux commerçants d'unifier leurs activités commerciales. Cette plateforme comprend, entre autres, une gamme d'outils permettant aux commerçants de créer et de personnaliser des boutiques en ligne, de vendre en plusieurs endroits (y compris sur le web, les téléphones portables, les médias sociaux, les places de marché en ligne et d'autres emplacements en ligne (« Services en ligne ») et en personne (« Services POS »)), de gérer les produits, l'inventaire, les paiements, l'exécution, l'expédition, les opérations commerciales, le marketing et la publicité, et d'entrer en contact avec les clients existants et potentiels. Tous ces services offerts par KStore sont désignés dans les présentes Conditions d'Utilisation comme le(s) « Service(s) ». Toute nouvelle fonctionnalité ou tout nouvel outil ajouté aux Services actuels sera également soumis aux Conditions d'Utilisation. Vous pouvez consulter la version actuelle des conditions d'utilisation à tout moment à l'adresse suivante : https://KStore.com.
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Vous êtes responsable du maintien de la confidentialité des informations d'identification de votre compte, y compris votre nom d'utilisateur et votre mot de passe. Toute activité se déroulant sous votre compte relève de votre seule responsabilité et vous devez informer Kstore immédiatement de toute utilisation non autorisée ou de toute atteinte à la sécurité. Le non-respect de cette obligation peut entraîner la suspension ou la résiliation de votre compte.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Vous vous engagez à fournir des informations exactes, à jour et complètes au cours de la procédure d'inscription et à mettre à jour ces informations si nécessaire pour qu'elles restent exactes, à jour et complètes. Kstore se réserve le droit de suspendre ou de résilier votre compte si l'une des informations fournies s'avère fausse, trompeuse ou incomplète.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Vous ne pouvez pas utiliser votre compte à des fins illégales ou non autorisées. Cela inclut, sans s'y limiter, la violation de toute loi dans votre juridiction, la violation des droits de propriété intellectuelle ou la participation à des activités frauduleuses. Kstore se réserve le droit d'enquêter et de prendre les mesures légales appropriées à l'encontre de tout utilisateur qui violerait ces conditions.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore peut, à sa seule discrétion, refuser le service, résilier les comptes ou limiter l'accès à la plate-forme pour quelque raison que ce soit, y compris, mais sans s'y limiter, en cas de violation des présentes conditions, d'activité frauduleuse ou d'utilisation abusive de la plate-forme. Vous reconnaissez que Kstore n'est pas responsable des pertes ou dommages résultant de ces actions.
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            En tant que propriétaire de magasin, vous êtes responsable de l'activation et de la gestion de votre magasin sur la plateforme Kstore. Une fois l'inscription réussie, il vous sera demandé d'achever le processus d'activation, qui peut inclure la vérification de votre identité, la fourniture de détails commerciaux et l'acceptation de conditions supplémentaires spécifiques aux propriétaires de magasins.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            <div class="d-flex justify-content-between">
                            <div class="d-flex mb-2">
                                <h6 class="lh-sm mb-0 me-2 text-body-secondary timeline-item-title">Droits de KStore</h6>
                            </div>
                            <p class="text-body-quaternary fs-9 mb-0 text-nowrap timeline-time"></p>
                            </div>
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore a le droit de refuser le service à quiconque pour quelque raison que ce soit et à tout moment. Cela inclut, sans s'y limiter, les utilisateurs qui se livrent à des activités frauduleuses, qui violent les droits de propriété intellectuelle ou qui utilisent la plateforme à mauvais escient. Nous pouvons également refuser de servir les utilisateurs dans les juridictions où nos services sont restreints ou interdits par la loi.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Nous nous réservons le droit de supprimer ou de désactiver l'accès à tout contenu qui enfreint les présentes conditions ou qui est jugé inapproprié, nuisible ou illégal. Cela inclut les listes de produits, les commentaires des clients et le contenu généré par les utilisateurs. Kstore n'est pas responsable des pertes ou dommages résultant de la suppression ou de la désactivation d'un tel contenu.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore peut utiliser des données agrégées et anonymes provenant de votre magasin à des fins d'analyse, de marketing ou d'amélioration. Ces données ne vous identifient pas personnellement, ni vos clients, et sont utilisées pour améliorer l'expérience globale de l'utilisateur sur la plateforme.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            En cas de litige entre vous et un autre utilisateur, Kstore se réserve le droit d'intervenir et de prendre les mesures appropriées pour résoudre le problème. Il peut s'agir de suspendre les transactions, de retenir des fonds ou de fournir des services de résolution des litiges. Notre décision en la matière est définitive et contraignante. 
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore traitera vos informations confidentielles avec le même soin. Toutefois, nous pouvons divulguer vos informations si la loi l'exige ou si cela est nécessaire pour faire respecter les présentes conditions ou protéger nos droits.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Notre responsabilité totale envers vous pour toute réclamation découlant des présentes conditions ou de votre utilisation de la plate-forme est limitée au montant que vous avez payé à Kstore au cours des six derniers mois. Si vous n'avez effectué aucun paiement, notre responsabilité est limitée à 100 $.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Vous acceptez d'indemniser et de dégager Kstore de toute responsabilité en cas de réclamation, de dommage ou de perte résultant de votre utilisation de la plateforme. Cela inclut, sans s'y limiter, les réclamations liées à la responsabilité du produit, à la violation de la propriété intellectuelle ou à la violation des présentes conditions.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore n'est pas responsable des services ou contenus de tiers liés ou intégrés à la plate-forme. L'utilisation de ces services se fait à vos risques et périls, et vous devez prendre connaissance des conditions générales de ces services et vous y conformer.
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            En téléchargeant ces éléments, vous accordez à Kstore une licence non exclusive, mondiale et libre de redevances pour les utiliser, les afficher et les distribuer en relation avec la plate-forme, d'utiliser, d'afficher et de distribuer ces éléments dans le cadre de la plate-forme.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore n'est pas responsable de toute violation des droits de propriété intellectuelle découlant de votre matériel. Si nous recevons une plainte valide pour violation des droits de propriété intellectuelle, nous pouvons supprimer ou désactiver l'accès au contenu litigieux sans préavis.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Vous vous engagez à ne pas télécharger ou distribuer de matériel diffamatoire, obscène ou contraire à la loi ou à la réglementation. Kstore se réserve le droit de supprimer de tels éléments et de prendre les mesures appropriées à l'encontre de votre compte.
                            </p>
                            <h6 class="fs-10 fw-bold mb-3">2 Propriété intellectuelle de Kstore</h6>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Tous les droits de propriété intellectuelle de la plate-forme, y compris, mais sans s'y limiter, les logiciels, les dessins, les logos et les marques, sont détenus par Kstore ou ses concédants de licence. Il est interdit d'utiliser, de copier ou de distribuer ces éléments sans autorisation écrite préalable.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Tout retour d'information ou suggestion que vous fournissez à Kstore concernant la plate-forme peut être utilisé par nous sans compensation ni obligation à votre égard. En soumettant des commentaires, vous accordez à Kstore une licence perpétuelle et irrévocable d'utilisation et de mise en œuvre de ces commentaires.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore se réserve le droit d'intenter une action en justice contre tout utilisateur qui enfreint ses droits de propriété intellectuelle. Cela inclut, sans s'y limiter, l'engagement de poursuites judiciaires, l'obtention d'injonctions ou la demande de dommages-intérêts.
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="col">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Vous pouvez vous retirer des services supplémentaires à tout moment en contactant le service d'assistance de Kstore. Toutefois, les frais payés pour ces services ne sont pas remboursables, sauf indication contraire dans les conditions du service spécifique.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore se réserve le droit de modifier ou d'interrompre des services supplémentaires à tout moment. Nous vous informerons dans un délai raisonnable de tout changement susceptible d'affecter votre utilisation de ces services.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            ...
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            Kstore n'est pas responsable des pertes ou dommages résultant de l'utilisation des services supplémentaires. Ceci inclut, mais n'est pas limité à, des erreurs dans les données analytiques, des campagnes de marketing inefficaces, ou des retards dans les réponses du support.
                            </p>
                            <p class="fs-9 text-body-secondary w-sm-100 mb-5">
                            En utilisant la plateforme Kstore, vous reconnaissez avoir lu, compris et accepté les présentes conditions d'utilisation. Si vous n'êtes pas d'accord avec une partie de ces conditions, vous ne devez pas utiliser la plateforme.
                            </p>
                        </div>
                        </div>
                    </div>
